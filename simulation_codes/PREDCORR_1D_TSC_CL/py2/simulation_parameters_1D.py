...
save_path       = 'runs/PRECORR_CL_TEST/'   # Series save dir   : Folder containing all runs of a series
...
adaptive_timestep   = False                                 # Flag (True/False) for adaptive timestep based on particle and field parameters
...
subcycles           = 8                                     # Number of (starting) field subcycling steps for Cyclic Leapfrog
subcycle_max        = 1000
