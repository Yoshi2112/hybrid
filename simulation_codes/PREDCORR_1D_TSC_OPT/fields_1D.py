...
from particles_1D_multithreaded import advance_particles_and_moments
...
@nb.njit()
def predictor_corrector(B, E_int, E_half, pos, vel, q_dens, idx, DT):
    '''
    ...
    Q, J            = advance_particles_and_moments(pos.copy(), vel.copy(), idx, B_pred, E_pred, DT)
