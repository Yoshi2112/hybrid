...
#@nb.njit()
def subcycle_B_RK4(B1, B2, B_center, rho, Ji, J_ext, E, Ve, Te, dt, subcycles,
    ...
    Note2: Do we need to put boundary conditions on curl_E?
        
    FIRST PASS: COMPLETELY UNOPTIMIZED. JUST TESTING IF IT WORKS.
    
    STORE ACCUMULATED ARGUMENT IN B2
    '''
    dh = 0.5 * dt / subcycles
    
    if disable_waves:
        return sim_time+(0.5*dt)
...
def store_run_parameters(dt, part_save_iter, field_save_iter, max_inc, max_time, subcycles):
    ...
    params = dict([('seed', seed),
                   ...
                   ('method_type', 'CAM_RK4_PARABOLIC_PARALLEL'),
                   ('particle_shape', 'TSC'),
...
if __name__ == '__main__':
    ...
    while _QQ < _MAX_INC:
        ...
        _SIM_TIME = subcycle_B_RK4(_B, _B2, _B_CENT, _RHO_INT, _Ji, _J_EXT, _E, _VE, _TE,
