...
### RUN DESCRIPTION ###
run_description = '''Checking all versions against LT. This is PREDCORR_1D_TSC.'''
...
density    = np.asarray([0.900, 0.100])     # Species charge density as normalized fraction (add to 1.0)
