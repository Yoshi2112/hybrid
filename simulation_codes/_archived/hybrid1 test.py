...
def initialize_particles():
    ...
    partin = np.array([[  1.00000000e+00],#,   4.00000000e+00],        #(0) Mass   (proton units)
                       ...
                       [             8e6],#,            0.5e6],        #(3) real density in /m3 - mantissa is density in /cm3
                       [  10.00000000e-01],#,   5.00000000e-01],        #(4) Simulated (superparticle) Density (as a portion of 1)
                       [  0.00000000e+00],#,   0.00000000e+00],        #(5) Distribution type         0: Uniform, 1: Sinusoidal
                       [               1],#,   1.00000000e+00],        #(6) Parallel      Temperature (eV) (x)
                       [              20],#,   1.00000000e+00],        #(7) Perpendicular Temperature (eV) (y, z)
...
if __name__ == '__main__':
    ...
    save_path      = 'Runs\Multi Species'          # Save path on 'drive' HDD - each run then saved in numerically sequential subfolder with images and associated data
...
#==============================================================================
            ...
            ax_vy_hot.set_ylabel(r'$H^+$', fontsize=24, rotation=0, labelpad=8) 
        
#==============================================================================
#             ax_vy_core.set_xlim(0, (NX*dx)/1000)
#             ax_vy_core.set_ylim(-15, 15)
#             ax_vy_core.set_xlabel('Position (km)', labelpad=10)
#             ax_vy_core.set_ylabel(r'$He^2+$', fontsize=24, rotation=0, labelpad=8) 
#==============================================================================
