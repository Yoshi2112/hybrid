...
### RUN DESCRIPTION ###
run_description = '''PREDCORR_1D_TSC_TIMEVAR :: Comparing against original CARLO for wavefront analysis, frequency, and timestep.'''
...
nsp_ppc  = 512                              # Number of particles per cell, per species - i.e. each species has equal representation (or code this to be an array later?)
