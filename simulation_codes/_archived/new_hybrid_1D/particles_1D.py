...
from simulation_parameters_1D  import N, dx, xmax, xmin, charge, mass, q, e_resis
...
@nb.njit(cache=True)
def boris_velocity_update(part, B, E, J, dt, W):
    ...
    for n in range(N):
        ...
        Jp = J[I,  0:3] * (1 - We   ) + J[I  + 1, 0:3] * We

        Ep -= (charge[idx] / q) * e_resis * Jp
