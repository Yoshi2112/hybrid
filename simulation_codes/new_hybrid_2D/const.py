...
save_path      = 'runs/func_test_2D'           # Save path on 'drive' HDD - each run then saved in numerically sequential subfolder with images and associated data
run_num        = 0                             # Default value. Will be modified at runtime
generate_data  = 0                             # Save data flag
generate_plots = 1                             # Save plot flag
...
NX       = 32                              # Number of cells - dimension of array (not including ghost cells)
NY       = 32
