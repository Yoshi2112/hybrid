...
def position_update(pos, vel, idx, dt, Ie, W_elec):
    ...
    INPUT/OUTPUT:
        pos    -- Particle positions to be updated
        vel    -- Particle velocities to be used and updated
        dt     -- Time cadence of simulation
        Ie     -- 
        W_elec -- Updated nearest E-field node value (0) and (1-2) left/centre weights
    '''
