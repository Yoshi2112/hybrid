...
### RUN DESCRIPTION ###
run_description = '''Marginal instability test for 25/07/2013 event -- Maximum growth parameters :: LARGER, CONSTRAINED RC'''
...
B_eq      = 231.431e-9                      # Initial magnetic field at equator: None for L-determined value (in T)
