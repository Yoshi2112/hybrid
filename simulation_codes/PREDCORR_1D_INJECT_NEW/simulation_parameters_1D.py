...
supress_text      = True                         # Supress initialization text
...
nsp_ppc    = np.array([200, 1200])                          # Number of particles per cell, per species - i.e. each species has equal representation (or code this to be an array later?)
