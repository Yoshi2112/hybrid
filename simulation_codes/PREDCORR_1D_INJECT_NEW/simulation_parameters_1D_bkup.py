...
nsp_ppc    = np.array([10, 10])                           # Number of particles per cell, per species - i.e. each species has equal representation (or code this to be an array later?)
...
dx         = 1.0#dxm * c / wpi                               # Spatial cadence, based on ion inertial length
