...
### RUN DESCRIPTION ###
run_description = '''Marginal instability test for 25/07/2013 event -- Maximum growth parameters :: HOMOGENOUS'''
...
B_eq      = 231.431                         # Initial magnetic field at equator: None for L-determined value (in T)
