...
if __name__ == '__main__':
    ...
    max_inc = 1
    while qq < max_inc:
        pos, qq, DT, max_inc, data_iter, plot_iter, change_flag = aux.check_timestep(qq, DT, pos, vel, B, E, dns_int, max_inc, data_iter, plot_iter)
        ...
        if qq%data_iter == 0 and generate_data == 1:                                   # Save data, if flagged
            pas.save_data(DT, data_iter, qq, pos, vel, J, E, B, dns_int)
