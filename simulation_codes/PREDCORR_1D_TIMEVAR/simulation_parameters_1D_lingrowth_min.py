...
save_path       = 'runs//july_25_lingrowth'     # Series save dir   : Folder containing all runs of a series
...
sim_repr   = np.asarray([1/9  , 1/9  , 1/9,
                         1/9  , 1/9  , 1/9,
                         1/9  , 1/9  , 1/9])                # Macroparticle weighting (redundant?): Percentage of macroparticles assigned to each species
...
# Override for direct simulation
