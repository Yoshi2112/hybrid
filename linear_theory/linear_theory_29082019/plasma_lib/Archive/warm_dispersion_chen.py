...
def get_dispersion_relation(field, ndensc, ndensw, A, t_perp, k_isnormalized=False, w_isnormalized=False, Nk=1000, kmin=0.0, kmax=1.0, plot=False, save=False, savepath=None):
    '''
    ...
    '''
    field  *= 1e-9   # Convert from nT to T
    ndensc *= 1e6    # Convert from cc to /m3
    ndensw *= 1e6    # Convert from cc to /m3
...
if __name__ == '__main__':
    ...
    get_dispersion_relation(_field, _ndensc, _ndensw, _A, _t_perp, k_isnormalized=False, w_isnormalized=True, plot=True)    