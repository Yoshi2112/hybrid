...
def dispersion_relations(B0, name, mass, charge, density, tper, ani, kmin=0.0, kmax=1.0,
    ...
    Returns w/k in angular SI units (angular frequency, angular wavenumber)
    
    Need to put in a check to make sure all arrays are the same size
    '''
...
if __name__ == '__main__':
    ...
    _k, CPDR, WPDR = dispersion_relations(_B0, _name, _mass, _charge, _density, _tper, _ani,
