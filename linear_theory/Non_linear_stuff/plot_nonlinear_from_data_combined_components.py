...
#%% MAIN
##
## Same as previous one, but this time try making a timeseries out of it.
## Get IMFs for each component. For the amplitude at a single time, use that Bw
## to get the B_th, B_opt as a function of frequency (there will only be one)
