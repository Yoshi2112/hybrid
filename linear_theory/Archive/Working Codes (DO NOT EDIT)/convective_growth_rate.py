...
#
# Made python callable as a function: March, 2019
...
def calculate_growth_rate(field, ndensc, ndensw, ANI, temperp=None, beta=None, norm_ampl=0, norm_freq=0, NPTS=500, maxfreq=1.0):
    ...
    # Set here since these are constant. Thought these were wrong because Z is usually atomic number, not charge state (+1 for all ions here)
    M    = np.zeros(N)
    M[0] = 1.0
    M[1] = 4.0
    M[2] = 16.0
